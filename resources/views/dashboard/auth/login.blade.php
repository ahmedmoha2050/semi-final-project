...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet"
          href="{{ asset('assets/dashboard/vendor/css/rtl/core.css') }}" class="template-customizer-core-css"/>
    <link rel="stylesheet"
      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle"
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
                    ...
                    <p class="mb-4">{{ __('dashboard/login.message') }}</p>
                    ...
                    <form id="formAuthentication" class="mb-3"
                        ...
                        @csrf
                        <div class="mb-3">
                            <label for="check" class="form-label">{{ __('dashboard/login.email_username_password') }}</label>
                            <input type="text" class="form-control" id="check" name="check"
                                   placeholder="{{ __('dashboard/login.enter_email_username_password') }}" autofocus>
                            <x-input-error key="check" />
                        </div>
                        <div class="mb-3 form-password-toggle">
                            <div class="d-flex justify-content-between">
                                <label class="form-label" for="password">{{ __('dashboard/login.password') }}</label>
                                <a href="auth-forgot-password-basic.html">
                                    <small>{{ __('dashboard/login.forget_password') }}</small>
                                </a>
                            </div>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary d-grid w-100" type="submit">{{ __('dashboard/login.login') }}</button>
                        </div>
                    </form>

                    <p class="text-center">
                        <span>{{ __('dashboard/login.guest') }}</span>
                        <a href="auth-register-basic.html">
                            <span>{{ __('dashboard/login.new_acc') }}</span>
                        </a>
                    </p>
